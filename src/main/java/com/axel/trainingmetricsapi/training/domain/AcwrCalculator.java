...
public class AcwrCalculator {
    ...
    // TODO: has to become private again once ACL (WeeklyLoadPort) is introduced to decouple wellness from training
    //  modules
    public AcwrReport computeFromWeeklyLoads(long athleteId, LocalDate weekStartDate,
